!(function () {
  ...
  const U = (e) => i(e) && 'a' === e.nodeName.toLowerCase(),
    ...
    Y = (e) => {
      ...
      return (
        !!n.collapsed ||
        0 === F(n, (e) => 1 === e.nodeType && !U(e) && !b(t, e.nodeName.toLowerCase())).length
      );
    },
      ...
      const o = e.selection.getNode(),
        ...
        l = ((e, t) => {
          ...
          return (
            ...
            (n.href = ((e, t) => (('http' !== t && 'https' !== t) || V(e) ? e : t + '://' + e))(
              n.href,
              A(e)
            )),
            n
    ...
    Ae = (e, t) =>
      ((e) => {
        ...
        return new Promise((e) => {
          ...
          e.bind(ue(t)).map((e) => (e.length > 0 ? [{ text: 'None', value: '' }].concat(e) : e))
        );
      })(e).then((n) => {
        const o = ((e, t) => {
          const n = e.dom,
  ...
  const Ne = (e, t) => {
    ...
    Pe = (e) => (t) => {
      const n = () => {
        (t.setActive(!e.mode.isReadOnly() && H(e, e.selection.getNode())),
