!(function () {
  ...
  const t = (e) => (t) => t.options.get(e),
    ...
    c = (e, t) => {
      if ((e = '' + e).length < t) for (let n = 0; n < t - e.length; n++) e = '0' + e;
      return e;
    },
    d = (e, t, n = new Date()) =>
      (t = (t = (t = (t = (t = (t = (t = (t = (t = (t = (t = (t = (t = (t = (t = t.replace(
        ...
        '%y',
        '' + n.getYear()
      )).replace('%m', c(n.getMonth() + 1, 2))).replace('%d', c(n.getDate(), 2))).replace(
        '%H',
        '' + c(n.getHours(), 2)
      )).replace('%M', '' + c(n.getMinutes(), 2))).replace(
        '%S',
        '' + c(n.getSeconds(), 2)
      )).replace('%I', '' + (((n.getHours() + 11) % 12) + 1))).replace(
        '%p',
        n.getHours() < 12 ? 'AM' : 'PM'
      )).replace('%B', '' + e.translate(m[n.getMonth()]))).replace(
        '%b',
        '' + e.translate(l[n.getMonth()])
      )).replace('%A', '' + e.translate(o[n.getDay()]))).replace(
        '%a',
        '' + e.translate(i[n.getDay()])
      )).replace('%%', '%'),
    u = (e, t) => {
      if (s(e) && e.selection.isEditable()) {
        const n = d(e, t);
        let a;
        a = /%[HMSIp]/.test(t) ? d(e, '%Y-%m-%dT%H:%M') : d(e, '%Y-%m-%d');
        ...
        r
          ...
          : e.insertContent('<time datetime="' + a + '">' + n + '</time>');
  ...
  e.add('insertdatetime', (e) => {
    (((e) => {
      ...
      ((e) => {
        (e.addCommand('mceInsertDate', (t, a) => {
          u(e, null != a ? a : n(e));
        }),
      ...
      ((e) => {
        ...
        e.ui.registry.addSplitButton('insertdatetime', {
          ...
          select: (e) => e === n.get(),
          fetch: (n) => {
            n(p.map(t, (t) => ({ type: 'choiceitem', text: d(e, t), value: t })));
          },
          onAction: (e) => {
            s(n.get());
          },
