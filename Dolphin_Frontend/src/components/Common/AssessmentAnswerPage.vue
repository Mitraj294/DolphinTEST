  ...
  <div class="assessment-answer-page">
    ...
    <div class="assessment-card">
      ...
      <form @submit.prevent="submitAnswers">
        ...
        >
          <label :for="'q-' + q.assessment_question_id" class="question-label">{{ q.text }}</label>
          <input
...
export default {
  ...
  async created() {
    ...
    try {
      ...
      const res = await axios.get(`${API_BASE_URL}/api/assessments/answer/${token}`);
  ...
  methods: {
    async submitAnswers() {
      ...
      try {
        ...
        await axios.post(`${API_BASE_URL}/api/assessments/answer/${token}`, payload);
